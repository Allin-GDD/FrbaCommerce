...
namespace FrbaCommerce.Datos
{
    class Dat_Listados
    {
        ...
        internal static void vendedoresQueMEnosVenden(Int16 año, Decimal visibilidad, int mes, DataGridView dataGridView1)
        {
            ...
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.listadoVendedoresQueVendenMenos", conn,
        ...
        internal static void vendedoresMayorFacturacion(short año, int filtroTrimestre, DataGridView dataGridView1)
        {
            ...
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.listadoMayoresFacturacion", conn,
              new SqlParameter("@Año", año),
        ...
        {
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.listadoMayoresCalificaciones", conn,
            new SqlParameter("@Año", año),
            new SqlParameter("@Trimestre", filtroTrimestre));
        ...
        {
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.listadoMayoresSinCalificaciones", conn,
              new SqlParameter("@Año", año),
            new SqlParameter("@Trimestre", filtroTrimestre));
