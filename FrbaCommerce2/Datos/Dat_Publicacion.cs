...
namespace FrbaCommerce.Datos
{
    class Dat_Publicacion
    {
        ...
        public static List<Entidades.Ent_Rubros> ObtenerRubros()
        {
            ...
            SqlCommand Comando = new SqlCommand("Select Codigo, Descripcion from allin.Rubro", conexion);
        ...
        public static List<Entidades.Ent_Visibilidad> ObtenerVisibilidades()
        {
            ...
            SqlConnection conexion = DBConexion.obtenerConexion();
            SqlCommand Comando = Utiles.SQL.crearProcedure("GD1C2014.allin.seleccionVisibilidadNotNull", conexion);
        ...
        public static void AgregarPublicacion(Entidades.Ent_Publicacion pPublicacion) //funca
        {
            ...
            using (SqlConnection conexion = DBConexion.obtenerConexion())
            {
                ...
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.agregarNuevaPublicacion", conexion,
        ...
        public static void EditarPublicacionBorrador(Entidades.Ent_Publicacion pPublicacion)
        {
            ...
            using (SqlConnection conexion = DBConexion.obtenerConexion())
            {
                ...
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.editarPublicacionBorrador", conexion,
                   new SqlParameter("@Visibilidad", pPublicacion.Visibilidad),
                   new SqlParameter("@Tipo", pPublicacion.Tipo),
                   new SqlParameter("@Stock", pPublicacion.Stock),
                   new SqlParameter("@Precio", pPublicacion.Precio),
        ...
        public static void EditarPublicacionBorradorAPublicada(Entidades.Ent_Publicacion pPublicacion)
        {
            ...
            using (SqlConnection conexion = DBConexion.obtenerConexion())
            {
                ...
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.editarPublicacionBorradorAPublicada", conexion,
                   new SqlParameter("@Visibilidad", pPublicacion.Visibilidad),
                   new SqlParameter("@Tipo", pPublicacion.Tipo),
                   new SqlParameter("@Stock", pPublicacion.Stock),
                   new SqlParameter("@Precio", pPublicacion.Precio),
        ...
        public static void EditarPublicacionPublicada(Entidades.Ent_Publicacion pPublicacion)
        {
            ...
            using (SqlConnection conexion = DBConexion.obtenerConexion())
            {
                ...
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.editarPublicacionPublicada", conexion,
        ...
        public static Boolean verificarTresGratuitas(Decimal usuario)
        {
            ...
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.verificarTresGratuitas", conn,
        ...
        public static Decimal buscarUsuarioCod(Decimal codigo)
        {
            ...
            Decimal usuario;
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.buscarUsuarioCod", conn,
        ...
        public static string obtenerDescripcionRubro(Decimal rubro) //funca
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerDescripcionRubro", conn,
        ...
        public static Decimal obtenerCodRubro(string descripcion)
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerCodRubro", conn,
        ...
        public static string obtenerVisibilidad(Decimal visib)
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerVisibilidad", conn,
        ...
        public static Boolean estaPausado(Decimal codigo)
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.verificarEstado", conn,
        ...
        public static Entidades.Ent_Publicacion buscarDatosPublicacion(Decimal codigoPk)
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.buscarDatosPublicacion", conn,
        ...
        public static Entidades.Ent_Fecha buscarDuracionVisibilidad(Decimal visibilidad) //funca
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.buscarDuracionVisibilidad", conn,
        ...
        {
            SqlConnection conexion = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.filtrarRubro", conexion,
           new SqlParameter("@codigo", codigo),
        ...
        internal static decimal obtenerCodTipoPublicacion(string tipo)
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerCodTipoPublicacion", conn,
        ...
        internal static decimal obtenerCodEstadoPublicacion(string estado)
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerCodEstadoPublicacion", conn,
        ...
        internal static string obtenerNombreTipoPublicacion(decimal tipo)
        {
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerNombreTipoPublicacion", conn,
        ...
        internal static void AgregarRubro(TextBox textBox1, Decimal codPublicacion)
        {
            ...
            using (SqlConnection conexion = DBConexion.obtenerConexion())
            {
                ...
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.agregarPublicacionRubro", conexion,
        ...
        internal static void QuitarRubro(TextBox textBox1, Decimal codPublicacion)
        {
            ...
            {
                rubro = Datos.Dat_Publicacion.obtenerCodRubro(textBox1.Text);
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.quitarPublicacionRubro", conexion,
                new SqlParameter("@codigo", codPublicacion),
                new SqlParameter("@rubro", rubro));
