...
namespace FrbaCommerce.Datos
{
    class Dat_Rol
    {
        ...
        {//listado de todos los roles
            ...
            SqlCommand Comando = new SqlCommand("Select Id, Nombre, Estado from allin.Rol", conexion);
        ...
        {//le agrega una funcionalidad a un determinado rol
            ...
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.agregarFuncionabilidadAlRol", conn,
        ...
        {//llena datagrid según un determinado filtro.
            SqlConnection conexion = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.filtrarRol", conexion,
        ...
        {//da de baja a un determinado rol
            int retorno;
            SqlConnection conexion = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.darDeBajaRol", conexion,
        ...
        public static string obtenerNombreIdRol(decimal rolADarDeBaja)
        {
            ...
            {//devuelve el nombre de un rol
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerNombreIdRol", conexion,
        ...
        {//quita de la tabla relación Rol_Func una determinada funcionalidad
            int retorno = 0;
            SqlConnection conexion = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.quitarRol", conexion,
                new SqlParameter("@Id_Rol", rol),
        ...
        {  //cambia estado a un rol
            try
            {
                int retorno = 0;
                SqlConnection conexion = DBConexion.obtenerConexion();
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.actualizarEstadoRol", conexion,
                    new SqlParameter("@Id_Rol", rol),
        ...
        {//obtiene el estado de un rol
            int estado = -1;
            SqlConnection conexion = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerEstado", conexion,
        ...
        {//agrega un determinado rol y su respectiva funcionalidad inicial
            ...
            using (SqlConnection conn = DBConexion.obtenerConexion())
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.agregarNuevoRol", conn,
        ...
        {//le cambia el nombre al rol
            ...
            using (SqlConnection conn = DBConexion.obtenerConexion())
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.actualizarNombreRol", conn,
        ...
        {//En el login según la cantidad de roles que tenga el usuario determina si abre una ventana para que elija un rol o
            ...
            {
                SqlConnection conexion = DBConexion.obtenerConexion();
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerTodosLosRoles", conexion,
        ...
        internal static Decimal obtenerIdRol(string RolNombre)
        {
            Decimal rol = 0;
            SqlConnection conexion = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.obtenerIdRol", conexion,
