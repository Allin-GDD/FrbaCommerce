    ...
    class Dat_Visibilidad
    {
        ...
        {//agrega una nueva visibilidad a la tabla Visibilidad
            ...
            using (SqlConnection conexion = DBConexion.obtenerConexion())
            {
                ...
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.agregarNuevaVisibilidad", conexion,
        ...
        {//obtiene todos los campos de una visibilidad a partir del codigo
            ...
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.buscarUnaVisibilidad", conn,
        ...
        {//actualiza los campos de una visibilidad
            ...
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.actualizarVisibilidad", conn,
        ...
        {//Llena datagrid con visibilidades según el filtro elegido.
                ...
                SqlConnection conn = DBConexion.obtenerConexion();
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.listaDeVisibilidades", conn,
        ...
        {//listado de todos las descripciones de las visibilidades. La usamos para evitar repetidos
            ...
            SqlCommand Comando = new SqlCommand("Select Descripcion from allin.Visibilidad", conexion);
        ...
        internal static bool validarCodigoDeVis(TextBox codigoAverificar)
        {
            ...
            SqlConnection conexion = DBConexion.obtenerConexion();
            SqlCommand Comando = new SqlCommand("select Codigo from allin.Visibilidad", conexion);
            SqlDataReader lectura = Comando.ExecuteReader();
