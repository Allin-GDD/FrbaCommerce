...
namespace FrbaCommerce.Datos
{
    class Dat_Usuario
    {
        ...
        {//arma un listado con todos los usuarios creados, para evitar repetidos
            ...
            SqlCommand Comando = new SqlCommand("Select usuario from allin.Usuario", conexion);
        ...
        {//agrega un nuevo usuario
            ...
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.darDeAltaUsuario", conexion,
        ...
        {//actualiza los estados del usuario
            ...
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.actualizarEstadoDelUsuario", conn,
                new SqlParameter("@Estado", estado),
        ...
        public static short obtenerEstado(Decimal id)
        {
            ...
            using (SqlConnection conn = DBConexion.obtenerConexion())
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.estaHabilitado", conn,
        ...
        public static Entidades.Ent_Usuario obtenerCamposDe(string nombre)
        {
            ...
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.buscarCamposDeUsuario", conn,
        ...
        {//actualiza los intentos de usuario
            ...
            using (SqlConnection conn = DBConexion.obtenerConexion())
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.actualizarIntentos", conn,
        ...
        {//actualiza la contraseña, (siempre la va a hashear)
            ...
            using (SqlConnection conn = DBConexion.obtenerConexion())
            {
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.actualizarContraseña", conn,
                new SqlParameter("@Usuario", usuario),
        ...
        {//Devuelve el Id_Usuario a partir del nombre de usuario
            Decimal user = 0;
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.buscarMiIDUsuario", conn,
        ...
        {//listado de funcionalidades
            ...
            SqlConnection conn = DBConexion.obtenerConexion();
            SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.allin.buscarFuncionalidades", conn,
