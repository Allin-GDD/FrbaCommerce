    ...
    public partial class Historial_Calificaciones : Form
    {
        ...
        private void inicializarListado2()
        {
            try
            {
                ...
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.dbo.historialCalificacionesRecibidas", conn,
        ...
        private void inicializarListado1()
        {
            try
            {
                ...
                SqlCommand cmd = Utiles.SQL.crearProcedure("GD1C2014.dbo.historialCalificacionesOtorgadas", conn,
                new SqlParameter("@Id", idCliente.ToString()));
                SqlDataAdapter da = new SqlDataAdapter { SelectCommand = cmd };
                da.Fill(tabla);
                conn.Close();
