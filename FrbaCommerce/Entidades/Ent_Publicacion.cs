...
namespace FrbaCommerce.Entidades
{
    public class Ent_Publicacion
    {
        ...
        public Ent_Publicacion(Decimal pVisibilidad, String pTipo, Decimal pRubro, Decimal pStock, Decimal pPrecio, String pDescripcion, Boolean pPermitir_Preguntas, String pPublicador, Decimal pId, DateTime pFecha_Venc)
        {
